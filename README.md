...
- [浅色主题 TODO](docs/planning/light-theme-todo.md)：已完成配色基础、主题选择/本机偏好，以及工作区、账号与学习弹窗、Markdown 阅读层的浅色适配；下一项为 3D/2D 图谱，随后适配 Mermaid/媒体。
